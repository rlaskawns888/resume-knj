...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    `
      ...
      스타트업에서 근무하면서 PM(Project Manager) 역할을 맡아 개발 체계를 구축하고, 솔루션 프로세스 개선에 기여한 경험이 있습니다.      
    `,
    `
      ...
      이러한 이유로 항상 커뮤니케이션과 메모를 중요시하며, 개발 과정에서 실수를 방지하기 위해 노력하였습니다.
    `,
    `
      저는 앞으로 다양한 기술적 경험을 쌓아, 여러 개발자에게 기술적인 경험을 공유하며 같이 성장할 수 있는 시니어 개발자가 되는 것이 목표입니다.
    `,
  ],
  sign: 'KNJ',
